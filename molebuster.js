...
const urlSuelo = "./img/bg/one.png";
const urlDigglet = "./img/bg/san.png";
...
const comprobacion = () => {
    ...
    if (puntuacion >= 5) {
        ...
        divPrincipal.innerHTML = `<div class="resultado"><img src="./img/bg/onee.gif"/><h3>GANADOR, ERES UN PIRATA</h3></div>`;

    } else {

        divPrincipal.innerHTML = `<div class="resultado"><img src="./img/bg/o.gif"/><h3>DERROTA, MEJOR VETE A COMODAR LOS BIGOTES</h3></div>`;
